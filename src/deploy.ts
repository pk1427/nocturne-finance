/**
 * Deploy nocturne-finance contract to a Midnight network (undeployed by default; use --network preview|preprod for public networks).
 *
...
const compiledContract = CompiledContract.make('nocturne-lending', NocturneLending.Contract).pipe(
  CompiledContract.withCompiledFileAssets(zkConfigPath),
);

// Dummy witnesses for deployment. The constructor does not call any witnesses,
// but the Contract class requires all witness functions to be present.
...
// Wrap the compiled contract to inject dummy witnesses at runtime.
...
async function main() {
  console.log('\n╔══════════════════════════════════════════════════════════════╗');
  console.log(`║  Deploy nocturne-finance to ${network}`);
  console.log('╚══════════════════════════════════════════════════════════════╝\n');
